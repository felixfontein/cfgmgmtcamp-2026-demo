...
options:
  ...
  hosttech_token:
    description:
      ...
      - Since felixfontein.antsibull_nox_playground 1.2.0, the alias O(ignore:api_token) can be used.
    aliases:
      - api_token
    type: str
    version_added: 0.2.0
...
options: {}
seealso:
  - ref: ansible_collections.felixfontein.antsibull_nox_playground.docsite.hosttech_guide.records
