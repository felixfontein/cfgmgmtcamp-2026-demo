...
options:
  ...
  simple_filters:
    description:
      ...
      - This option used to be called O(filters) before felixfontein.antsibull_nox_playground 3.0.0. It has been renamed from O(filters) to O(simple_filters)
        in felixfontein.antsibull_nox_playground 2.8.0, and the old name was still available as an alias until
        felixfontein.antsibull_nox_playground 3.0.0. O(filters) is now used for something else.
    type: dict
    default: {}
    suboptions:
