...
description:
  ...
  - 'For Ansible to be able to identify a YAML file as an inventory for this plugin, the inventory file must contain C(plugin:
    felixfontein.antsibull_nox_playground.hetzner_dns_records) and its filename must end with C(hetzner_dns.yaml) or C(hetzner_dns.yml).'
options:
  plugin:
    description: The name of this plugin. Should always be set to V(felixfontein.antsibull_nox_playground.hetzner_dns_records) for this plugin to
      recognize it as its own.
    required: true
    choices:
      - felixfontein.antsibull_nox_playground.hetzner_dns_records
    type: str
...
extends_documentation_fragment:
  ...
  - felixfontein.antsibull_nox_playground.hetzner.plugin
  - felixfontein.antsibull_nox_playground.hetzner.record_type_choices_records_inventory
...
seealso:
  - module: felixfontein.antsibull_nox_playground.hetzner_dns_record_set_info
  - module: felixfontein.antsibull_nox_playground.hetzner_dns_record_info
"""

EXAMPLES = r"""
# filename must end with hetzner_dns.yaml or hetzner_dns.yml

plugin: felixfontein.antsibull_nox_playground.hetzner_dns_records
zone_name: domain.de
simple_filters:
  type:
    - TXT
...
class InventoryModule(RecordsInventoryModule):
    NAME = "felixfontein.antsibull_nox_playground.hetzner_dns_records"
