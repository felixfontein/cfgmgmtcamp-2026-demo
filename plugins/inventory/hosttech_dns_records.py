...
description:
  ...
  - 'For Ansible to be able to identify a YAML file as an inventory for this plugin, the inventory file must contain C(plugin:
    felixfontein.antsibull_nox_playground.hosttech_dns_records) and its filename must end with C(hosttech_dns.yaml) or C(hosttech_dns.yml).'
options:
  plugin:
    description: The name of this plugin. Should always be set to V(felixfontein.antsibull_nox_playground.hosttech_dns_records) for this plugin to
      recognize it as its own.
    required: true
    choices:
      - felixfontein.antsibull_nox_playground.hosttech_dns_records
    type: str
...
extends_documentation_fragment:
  ...
  - felixfontein.antsibull_nox_playground.hosttech.plugin
  - felixfontein.antsibull_nox_playground.hosttech.record_type_choices_records_inventory
  ...
  - felixfontein.antsibull_nox_playground.inventory_records
...
seealso:
  - module: felixfontein.antsibull_nox_playground.hosttech_dns_record_set_info
  - module: felixfontein.antsibull_nox_playground.hosttech_dns_record_info
"""

EXAMPLES = r"""
# filename must end with hosttech_dns.yaml or hosttech_dns.yml

plugin: felixfontein.antsibull_nox_playground.hosttech_dns_records
zone_name: domain.ch
simple_filters:
  type:
    - AAAA
...
from ansible_collections.felixfontein.antsibull_nox_playground.plugins.module_utils.http import OpenURLHelper
from ansible_collections.felixfontein.antsibull_nox_playground.plugins.plugin_utils.inventory.records import (
    RecordsInventoryModule,
)
from ansible_collections.felixfontein.antsibull_nox_playground.plugins.plugin_utils.templated_options import (
    TemplatedOptionProvider,
)


class InventoryModule(RecordsInventoryModule):
    NAME = "felixfontein.antsibull_nox_playground.hosttech_dns_records"
