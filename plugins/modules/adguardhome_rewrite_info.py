...
extends_documentation_fragment:
  - felixfontein.antsibull_nox_playground.adguardhome.connectivity
...
- name: Get DNS rewrites from AdGuardHome
  register: rewrite
  felixfontein.antsibull_nox_playground.adguardhome_rewrite_info:
    username: admin
    password: admin
...
from ansible_collections.felixfontein.antsibull_nox_playground.plugins.module_utils.adguardhome.api import (
