...
- name: Retrieve TXT values from all nameservers for two DNS names
  felixfontein.antsibull_nox_playground.nameserver_record_info:
    name:
      - www.example.com
      - example.org
    type: TXT
      ...
      contains:
        ...
        values:
          description:
            ...
            - B(The field has been renamed) to RV(results[].result[].entries) in felixfontein.antsibull_nox_playground 3.4.0.
