...
extends_documentation_fragment:
  ...
  - felixfontein.antsibull_nox_playground.module_zone_info
...
- name: Retrieve details for foo.com zone
  felixfontein.antsibull_nox_playground.hosttech_dns_zone_info:
    zone_name: foo.com
...
from ansible_collections.felixfontein.antsibull_nox_playground.plugins.module_utils.module.zone_info import (
