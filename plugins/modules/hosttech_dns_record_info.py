...
extends_documentation_fragment:
  ...
  - felixfontein.antsibull_nox_playground.module_record_info
...
- name: Retrieve the details for the A records of new.foo.com
  felixfontein.antsibull_nox_playground.hosttech_dns_record_info:
    zone_name: foo.com
    record: new.foo.com
    type: A
...
from ansible_collections.felixfontein.antsibull_nox_playground.plugins.module_utils.module.record_info import (
