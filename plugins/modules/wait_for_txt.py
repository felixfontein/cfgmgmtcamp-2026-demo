    ...
    suboptions:
      ...
      values:
        description:
          ...
          - The alias O(records[].entries) has been added in felixfontein.antsibull_nox_playground 3.4.0.
        aliases:
          - entries
        type: list
        elements: str
...
- name: Wait for a TXT entry to appear
  felixfontein.antsibull_nox_playground.wait_for_txt:
    records:
  ...
  contains:
    ...
    values:
      description:
        ...
        - B(The field has been renamed) to RV(records[].entries) in felixfontein.antsibull_nox_playground 3.4.0.
