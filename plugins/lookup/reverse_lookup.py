...
- name: Look up hostname of IPv4 address
  ansible.builtin.debug:
    msg: "{{ query('felixfontein.antsibull_nox_playground.reverse_lookup', '192.168.1.1') }}"

- name: Look up hostname of IPv6 address
  ansible.builtin.debug:
    msg: "{{ query('felixfontein.antsibull_nox_playground.reverse_lookup', '1:2:3::4') }}"
"""
...
class LookupModule(LookupBase):
    ...
    def run(
        ...
        assert_requirements_present_dnspython("felixfontein.antsibull_nox_playground.reverse_lookup", "lookup")
        assert_requirements_present_ipaddress("felixfontein.antsibull_nox_playground.reverse_lookup", "lookup")
