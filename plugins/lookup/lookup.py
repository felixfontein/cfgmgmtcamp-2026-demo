...
- name: Look up A (IPv4) records for example.org
  ansible.builtin.debug:
    msg: "{{ query('felixfontein.antsibull_nox_playground.lookup', 'example.org.') }}"

- name: Look up AAAA (IPv6) records for example.org
  ansible.builtin.debug:
    msg: "{{ query('felixfontein.antsibull_nox_playground.lookup', 'example.org.', type='AAAA' ) }}"
"""
...
class LookupModule(LookupBase):
    ...
    def run(
        ...
        assert_requirements_present_dnspython("felixfontein.antsibull_nox_playground.lookup", "lookup")
        ...
        if self.get_option("server"):
            server_addresses = []
            assert_requirements_present_ipaddress("felixfontein.antsibull_nox_playground.lookup", "lookup")
