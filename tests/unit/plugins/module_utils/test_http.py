...
from ansible_collections.felixfontein.antsibull_nox_playground.plugins.module_utils.http import (
    NetworkError,
    OpenURLHelper,
)
...
def test_open_url_helper_1(mocker):
    ...
    mocker.patch('ansible_collections.felixfontein.antsibull_nox_playground.plugins.module_utils.http.open_url', open_url)
