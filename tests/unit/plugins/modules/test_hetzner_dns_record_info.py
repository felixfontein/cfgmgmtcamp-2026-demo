...
from ansible_collections.felixfontein.antsibull_nox_playground.plugins.modules import hetzner_dns_record_info
...
class TestHetznerDNSRecordInfoJSON(BaseTestModule):
    MOCK_ANSIBLE_MODULEUTILS_BASIC_ANSIBLEMODULE = (
        'ansible_collections.felixfontein.antsibull_nox_playground.plugins.modules.hetzner_dns_record_info.AnsibleModule'
    )
