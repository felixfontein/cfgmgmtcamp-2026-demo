...
from ansible_collections.felixfontein.antsibull_nox_playground.plugins.modules import hetzner_dns_record_set
...
class TestHetznerDNSRecordJSON(BaseTestModule):
    MOCK_ANSIBLE_MODULEUTILS_BASIC_ANSIBLEMODULE = (
        'ansible_collections.felixfontein.antsibull_nox_playground.plugins.modules.hetzner_dns_record_set.AnsibleModule'
    )
