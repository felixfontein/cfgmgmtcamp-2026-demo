...
from ansible_collections.felixfontein.antsibull_nox_playground.plugins.modules import hosttech_dns_zone_info
...
class TestHosttechDNSZoneInfoWSDL(BaseTestModule):
    MOCK_ANSIBLE_MODULEUTILS_BASIC_ANSIBLEMODULE = (
        'ansible_collections.felixfontein.antsibull_nox_playground.plugins.modules.hosttech_dns_zone_info.AnsibleModule'
    )
