...
from ansible_collections.felixfontein.antsibull_nox_playground.plugins.modules import (
...
class TestHosttechDNSRecordSetInfoWSDL(BaseTestModule):
    MOCK_ANSIBLE_MODULEUTILS_BASIC_ANSIBLEMODULE = (
        'ansible_collections.felixfontein.antsibull_nox_playground.plugins.modules.hosttech_dns_record_set_info.AnsibleModule'
    )
