...
import ansible_collections.felixfontein.antsibull_nox_playground.plugins.module_utils.http  # noqa: F401, pylint: disable=unused-import
from ansible_collections.felixfontein.antsibull_nox_playground.plugins.modules import hosttech_dns_record
...
class TestHosttechDNSRecordWSDL(BaseTestModule):
    MOCK_ANSIBLE_MODULEUTILS_BASIC_ANSIBLEMODULE = 'ansible_collections.felixfontein.antsibull_nox_playground.plugins.modules.hosttech_dns_record.AnsibleModule'
    MOCK_ANSIBLE_MODULEUTILS_URLS_FETCH_URL = 'ansible_collections.felixfontein.antsibull_nox_playground.plugins.module_utils.http.fetch_url'
