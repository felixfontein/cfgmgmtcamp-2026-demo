...
from ansible_collections.felixfontein.antsibull_nox_playground.plugins.plugin_utils import resolver
...
def test_assert_requirements_present() -> None:
    ...
    try:
        ...
        assert_requirements_present("felixfontein.antsibull_nox_playground.foo", "lookup")
